...
interface DataMidChartRowProps {
  midChartsData: Array<{
    metric: MaMetricType;
...
/**
 * 4-column row of medium-sized Data charts for non-primary metrics.
 * Clicking a card swaps that metric with the big chart.
 */
export default function DataMidChartRow({
  midChartsData,
  primaryMetric,
  onMetricSwap,
}: DataMidChartRowProps) {
  return (
...
const DataMidCard = memo(function DataMidCard({
  metric,
  data,
  onSwap,
}: DataMidCardProps) {
